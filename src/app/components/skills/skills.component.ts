...
backends = [
  ...
  { name: 'FastAPI', logo: 'https://cdn.jsdelivr.net/npm/devicon@2.16.0/icons/python/python-original.svg', isInvertLogo: false }
];
  ...
  databases = [
    ...
    { name: 'Firebase Firestore', logo: 'https://cdn.jsdelivr.net/npm/devicon@2.16.0/icons/firebase/firebase-plain.svg', isInvertLogo: false },
  ...
  opss = [
    ...
    { name: 'Google Cloud', logo: 'https://cdn.jsdelivr.net/npm/devicon@2.16.0/icons/googlecloud/googlecloud-original.svg', isInvertLogo: false },
